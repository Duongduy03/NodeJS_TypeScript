...
import { ICart, ICategory, IProduct, IUser } from "./interface/Interface";
...
import { authenticate, isAuthenticate, isCartItem } from "./utils/localStorage";
...
function App() {
  ...
  const customers = isAuthenticate();
    ...
    <div className="App">
      <Routes>
        <Route path="/" element={<ClientLayout />}>
          ...
          <Route
            path={`${customers?.name}`}
            element={<Customer onLogOut={onHandleLogOut} />}
          />

          <Route path={`/viewcart`} element={<ViewCart />} />
          <Route path={`/viewcart/bill`} element={<Bill />} />
        </Route>
